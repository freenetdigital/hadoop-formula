...
{%- set whitelist_proxy_cn        = gc.get('whitelist_proxy_cn', pc.get('whitelist_proxy_cn','')) %}
...
{%- do nifi.update({ 'version'                  : version,
                     ...
                     'flow_persistence_provider': flow_persistence_provider,
                     'remote_to_push'           : remote_to_push,
                     'registry_ldap'            : registry_ldap,
                     'reg_init_admin'           : reg_init_admin,
                     'whitelist_proxy_cn'       : whitelist_proxy_cn,
                   }) %}
